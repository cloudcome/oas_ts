import { OpenAPIVersion, type OpenAPIV3, type OpenAPIV3_1 } from '../types/openapi';
import { objectMap } from '../utils/object';
import { isArray, isBoolean, isUndefined } from '../utils/type-is';
...
function migHeader(header: OpenAPIV3.HeaderObject | OpenAPIV3.ReferenceObject | undefined): OpenAPIV3_1.HeaderObject | OpenAPIV3_1.ReferenceObject | undefined {
    ...
    if ('$ref' in header) return header;
